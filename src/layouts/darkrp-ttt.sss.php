    ...
    <div>
            ...
            <div class="accordion" id="errorMenuAccordion">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed text-primary-emphasis" type="button"
                                data-bs-toggle="collapse"
                                data-bs-target="#collapseErrorMenuContentDownload" aria-expanded="true">
                            Özel İçerikleri indirme
                        </button>
                    </h2>
                    <div id="collapseErrorMenuContentDownload" class="accordion-collapse collapse"
                         data-bs-parent="#errorMenuAccordion">
                        <div class="accordion-body">
                            <div class="row">
                                <div class="col-md-6 text-center">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <ol>
                                        ...
                                        <li>"Geliştirici Konsoluna geçiş" bulun ve <span class="key">é</span> tuşunu
                                            atayınız.
                                        </li>
                                        <li>Uygula basınız.</li>
                                        <li><span class="key">é</span> tuşuna basarak konsolu açınız</li>
                                        <li>
        ...
        <div>
            ...
            <?php if ($darkRPContent) { ?>
                <p><span class='key'>ESC</span> tuşuna basınız, ardından "Oyun Ayarları"na basınız. "Görüntü" kısmına
                    gelerek "Gelişmiş"e
            ...
            <?php } ?>
            <?php if ($tttContent) { ?>
                <p><span class='key'>ESC</span> tuşuna basınız, ardından "Ayarlar" basınız. "Görüntü" kısmına gelerek
                    "Gelişmiş"e
                    tıklayınız ve ardından "Model Detayı"nı yüksek seviyeye ayarlayınız.
                </p>
                <p>Ancak, bu değişikliği
        ...
        <div>
            ...
            <p>Eğer sorun çözülmez ise konsolu (<span class="key">é</span>) açınız ve aşağıdaki komutları yazınız.</p>
            <pre><code>unbindall
exec config_default.cfg
    ...
    <div>
        ...
        <div>
            ...
            <?php if ($darkRPContent) { ?>
                <p><span class='key'>ESC</span> tuşuna basınız, ardından Menüden FPS Yükseltme seçiniz.
                </p>
            <?php } ?>
            <?php if ($tttContent) { ?>
                <p><span class='key'>I</span> tuşuna basınız, Ayarlar Tıklayınız, FPS Yükseltme Seçiniz
                </p>
            <?php } ?>
        </div>
    </div>