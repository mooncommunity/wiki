                    ...
                    <ul style="list-style-type: '— ';">
                        ...
                        <li><strong>/dropmoney &lt;Miktar&gt;:</strong><span> Yere belirtiğiniz miktarda para
                            atar.</span><br><em class="text-success-emphasis">Örnek:</em><br><code>/dropmoney
                                1000</code></li>
                        <hr>
                        <li><strong>/give &lt;Miktar&gt;:</strong><span> CrossHair(<i class="fa-thin fa-plus" style="color: #63E6BE;"></i>) ile baktığınız kişiye para
                            atar.</span><br><em class="text-success-emphasis">Örnek:</em><br><code>/give
                                1000</code></li>
                        <hr>
