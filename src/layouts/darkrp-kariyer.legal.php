    ...
    <div class="content pt-3">
        ...
        <div>
            ...
            <div>
                                ...
                                <div id="collapse<?= $index ?>"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <?php if (!empty($job['whitelist'])): ?>
                                            <small class="text-light">Bu meslek whitelistlidir. Daha fazla bilgi için <a style="text-decoration: none" href="<?= $baseUrl ?>/darkrp-baslarken/sss#basvuru"> Sıkça Sorulan Sorular - Başvurular</a> bakınız.</small>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                ...
                <div>
                    <h2 class="standartcolor" id="taser">Taser Hangi Durumlarda Kullanılmalıdır ve Kullanılmamalıdır?</h2>
                    ...
                    <ul style="list-style-type: '* '">
                        ...
                        <li><span><strong class="text-teal">Kaçma veya Zarar Verme Olasılığı Olmayan Bir Şüpheli:</strong> Eğer şüpheli herhangi
                ...
                <div>
                    ...
                    <div class="text-center">
                        <img src="<?= $baseUrl ?>/assets/image/darkrp_gbt.png" class="img-fluid"
