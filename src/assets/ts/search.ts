import { baseUrl, baseUrl_Path, currentUrl } from './scripts.js';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const searchIcon = document.getElementById('searchButton') as HTMLElement;
    ...
    const navbarNav = document.getElementById('navbarNav') as HTMLElement;

    function toggleSearchIcon(): void {
    ...
    searchIcon.addEventListener('click', () => {
        // @ts-ignore
        const modal = new bootstrap.Modal(document.getElementById('searchModal') as HTMLElement);
        modal.show();
    });
