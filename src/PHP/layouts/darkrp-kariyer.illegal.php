    ...
    <div class="content pt-3">
        ...
        <div>
            ...
            <div class="accordion" id="accordionJobs">
                <?php foreach ($darkrpJobs['illegal']['jobs'] as $index => $job): ?>
        ...
        <div>
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div>
                        <details>
                            <summary>Hangi Meslekte Yapabilirim?</summary>
                            <ul style="list-style-type: '- '">
                                <?php
                                $illegalJobs = $darkrpJobs['illegal']['jobs'];
                                foreach ($illegalJobs as $job) {
                                    if (isset($job['printer']) && $job['printer'] === true) {
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <p>
                        ...
                        Makineyi çıkarmak çok basittir; <kbd>F4</kbd> menüsünden "Varlıklar" bölümüne giderek, ardından
                        "Para Basma
                            ...
                            <ul style="list-style-type: '* '">
                                ...
                                foreach ($illegalJobs as $job) {
                                    if (isset($job['bitki3']) && $job['bitki3'] === true) {
                                        ...
                                        echo '<li>' . htmlspecialchars($job['title']) . '</li>';
                                    } elseif (isset($job['bitki1']) && $job['bitki1'] === true) {
                                        echo '<li>' . htmlspecialchars($job['title']) . '</li>';
                                    }
                                }
                                ?>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <p>
                        ...
                        olmalısınız. Mafya Üyesi olduğunuzda, yine <kbd>F4</kbd> menüsünden çıkardığınız saksılar ile
                        ...
                        vb.) temin edebilirsiniz. Bu ürünleri temin ettikten sonra, saksıya bakarak 2 kere <kbd>E</kbd>
