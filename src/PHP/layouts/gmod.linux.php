            ...
            <div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 text-center">
                        <p><img src="<?= $baseUrl ?>/assets/image/steam_gmod_ozellikler.png" alt=""
                                                   class="img-fluid img-zoom"></p>
                    </div>
                    <div class="col-md-6">
                        <ol>
                ...
                <div class="row align-items-center mt-4">
                    <div class="col-md-6 text-center">
                        <img src="<?= $baseUrl ?>/assets/image/steam_proton.png" alt="" class="img-fluid img-zoom">
                    </div>
                    <div class="col-md-6">
                        <ol start="4">
                            <li>Uyumluluk</li>
